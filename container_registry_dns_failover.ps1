...
[Parameter(Mandatory=$true)][string]$container_registry_private_dns_zone_name,               #Enter the name of the private dns zone
[Parameter(Mandatory=$true)][string]$container_registry_private_dns_zone_global_record_name,
[Parameter(Mandatory=$true)][string]$container_registry_private_dns_zone_primary_region_record_name,
[Parameter(Mandatory=$true)][string]$container_registry_private_dns_zone_secondary_region_record_name,             #Enter the name of the recordname to be updated
[Parameter(Mandatory=$true)][string]$container_registry_global_endpoint_primary_region_IP,                   #Enter the new IP to be added
[Parameter(Mandatory=$true)][string]$container_registry_global_endpoint_secondary_region_IP,                   #Enter the old IP to be removed
[Parameter(Mandatory=$true)][string]$container_registry_primary_endpoint_primary_region_IP,
[Parameter(Mandatory=$true)][string]$container_registry_primary_endpoint_secondary_region_IP,
[Parameter(Mandatory=$true)][string]$container_registry_secondary_endpoint_primary_region_IP,
[Parameter(Mandatory=$true)][string]$container_registry_secondary_endpoint_secondary_region_IP
)
...
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_global -Ipv4Address $container_registry_global_endpoint_secondary_region_IP
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_primary_region -Ipv4Address $container_registry_primary_endpoint_secondary_region_IP
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_secondary_region -Ipv4Address $container_registry_secondary_endpoint_secondary_region_IP
...
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet_primary_region -Ipv4Address $container_registry_primary_endpoint_primary_region_IP
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet_secondary_region -Ipv4Address $container_registry_secondary_endpoint_primary_region_IP
