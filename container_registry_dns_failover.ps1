...
[Parameter(Mandatory=$true)][string]$container_registry_private_dns_zone_record_name,             #Enter the name of the recordname to be updated
[Parameter(Mandatory=$true)][string]$container_registry_primary_private_endpoint_IP,                   #Enter the new IP to be added
[Parameter(Mandatory=$true)][string]$container_registry_secondary_private_endpoint_IP                   #Enter the old IP to be removed
)
...
$RecordSet = Get-AzPrivateDnsRecordSet -ResourceGroupName $private_dns_zone_resource_group_name -ZoneName $container_registry_private_dns_zone_name -Name $container_registry_private_dns_zone_record_name -RecordType A

Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet -Ipv4Address $container_registry_secondary_private_endpoint_IP
